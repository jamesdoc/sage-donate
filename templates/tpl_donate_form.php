<form method="POST" class="sagedonateform" action="<?php echo esc_url( $_SERVER['REQUEST_URI'] ); ?>">
    ...
    <fieldset class="sagedonateform__name">
        <p>
            ...
            <label for="txt_name_first">First name <span class="required">*</span></label>
    ...
    <fieldset class="sagedonateform__address">
        <p>
            ...
            <label for="txt_address1">Address line 1 <span class="required">*</span></label>
        ...
        <p>
            ...
            <label for="txt_city">Town/City <span class="required">*</span></label>
        ...
        <p>
            ...
            <label for="txt_postcode">Post Code <span class="required">*</span></label>
            <input type="text" name="txt_postcode" id="txt_postcode" value="<?php if(isset($user_input['postcode'])){ echo $user_input['postcode']; } ?>" />
        </p>

        <p>
            <label for="cbo_country">Country <span class="required">*</span></label>
